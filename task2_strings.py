...
messy_names[0] = messy_names[0].strip().lower()
messy_names[1] = messy_names[1].strip().lower()
messy_names[2] = messy_names[2].strip().lower()
...
# c)
print(f"#1 Best Seller: {video_game_sales[0][NAME]} ({video_game_sales[0][YEAR]}) - ${video_game_sales[0][GLOBAL_SALES]:.2f}M global sales")
